import { Plan, Prediction, PredictionResult, MatchStatus, SubscriptionTier, Tipster, PaymentTransaction, PaymentStatus, User, BlogPost } from "../types";
...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    subscriptionExpiryDate: getFutureDate(2) // Expires in 2 days (Trigger warning)
  },
  {
    id: 'u3',
    name: 'Standard User',
...
export const MOCK_PREDICTIONS: Prediction[] = [
  ...
  // Historical / Finished Games for Records
  {
    id: 'h1',
    league: 'Premier League',
    homeTeam: 'Liverpool',
...
export const MOCK_BLOG_POSTS: BlogPost[] = [
    {
        ...
        content: `
            <p>Analyzing football matches goes beyond just looking at the league table. Professional bettors dive deep into underlying metrics.</p>
            <h3>1. Expected Goals (xG)</h3>
            <p>xG provides a more accurate picture of a team's performance than actual goals scored. It measures the quality of chances created.</p>
            <h3>2. Team News & Injuries</h3>
            <p>A key player missing can drastically change a team's probability of winning. Always check the latest squad lists.</p>
            <h3>3. Motivation Factor</h3>
            <p>Is the team fighting for the title or avoiding relegation? Motivation plays a huge role, especially at the end of the season.</p>
        `,
    ...
    },
    {
        ...
        excerpt: 'Why emotional control is more important than your strategy. Learn how to manage your bankroll effectively.',
        content: `
            <p>The biggest enemy of a bettor is not the bookie, but their own emotions. Chasing losses is the fastest way to bankruptcy.</p>
            <p>Stick to a staking plan. Never bet more than 5% of your bankroll on a single game, no matter how confident you are.</p>
        `,
        author: 'Admin User',
        date: '2023-11-18',
    ...
    },
    {
        ...
        excerpt: 'Exclusive high-value opportunities identified by our AI model for the upcoming weekend fixtures.',
        content: `
            <p>This weekend presents some unique opportunities where bookmakers have mispriced certain outcomes based on recent bias.</p>
            <p><strong>Pick 1: Aston Villa vs Tottenham</strong></p>
            <p>Our model suggests value on Over 3.5 goals due to both teams' high defensive lines and attacking output.</p>
        `,
        author: 'Ola The Oracle',
        date: '2023-11-24',
